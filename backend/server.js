...
const db = mysql.createConnection({
  host: process.env.DB_HOST || 'bm9mqk2etncqpruhciaq-mysql.services.clever-cloud.com',
  user: process.env.DB_USER || 'ugcmjepgxqmyzqg',
  password: process.env.DB_PASSWORD || 'vh93EQHqwjyMhx4APlji', 
  database: process.env.DB_NAME || 'bm9mqk2etncqpruhciaq'  
});
